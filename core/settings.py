...
DATABASES = {
    'default': {
        ...
        'PASSWORD': os.getenv('POSTGRES_PASSWORD', 'UgXlfrboZBoBrNqjhGWGbzUJAfPiiEKX'),
        'HOST': os.getenv('POSTGRES_HOST', 'hopper.proxy.rlwy.net'),
        'PORT': os.getenv('POSTGRES_PORT', '48035'),
    }
}
